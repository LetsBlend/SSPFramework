...
void Engine::Run()
{
	...
	ImGui_ImplDX11_Init(gD3D11._device.Get(), gD3D11._deviceContext.Get());
	...
	while (UpdateApplication)
	{
		...
		ImGui::Render();
		gD3D11._deviceContext->OMSetRenderTargets(1, cam.m_renderTargetView.GetAddressOf(), nullptr);
